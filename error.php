            ...
            <div class="container">
                <div class="clearfix">
                    <div class="float-left">
                        <div class="main-logo">
                            <a class="navbar-brand pr-50" href="index.php"><img src="images/logo.png" class="logo" alt=""></a>
                        </div>
                    </div>
                            ...
                            <div class="navbar-collapse collapse justify-content-center align-items-center w-100">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="#">Blog</a>
                                        <ul>
                                            <li><a href="blog-1.php">Blog Grid</a></li>
                                            <li><a href="blog-2.php">Blog Sidebar</a></li>
                                            <li><a href="blog-details.php">Blog Details One</a></li>
                                            <li><a href="blog-details2.php">Blog Details two</a></li>
                                        </ul>
                                    </li>
    ...
    <section class="error-page-section">
        <div class="container">
            <div class="content-box">
                <div class="image"><img src="images/icons/error-icon.png" alt=""></div>
                <h1>404</h1>
                <h2>PAGE NOT FOUND</h2>
                <p>The page you were looking for could not be found. <a href="index.php">Go to Home Page</a></p>
                <form action="#">
                        ...
                        <div class="footer-widget about-widget">
                            ...
                            <div class="widget-content">
                                ...
                                <ul class="contact-info">
                                    ...
                                    <li>Email ; <a href="#">security@support.com</a></li>
                                </ul>
                ...
                <div class="clearfix">
                    <div class="float-sm-left">
                        <div class="copyright-text">
                            <p>Copyrights © 2018 <a href="index.php">Bilbao</a>. All rights reserved.</p>
                        </div>
                    </div>
                    <div class="float-sm-right">
                        <ul>
                            <li><a href="#">Privacy Policy</a></li>
                            <li><a href="#">erms & Condition</a></li>
                        </ul>
                    </div>
                </div>   
            </div>
